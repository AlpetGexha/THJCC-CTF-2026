...
def redirect_page_function():
    ...
    r_body = {
        "client": {"clientId": "thjccanon-forum", "clientVersion": "1.0"},
        "threatInfo": {
            "threatTypes": [
    ...
    api_response = requests.post(
        f"https://safebrowsing.googleapis.com/v4/threatMatches:find?key={os.environ.get('GOOGLE_SAFE_BROSWERING_API_KEY')}",
        json=r_body,
        timeout=60,
    )
