...
def og():
    ...
    content = BeautifulSoup(
        little_conponment.markdown_to_html_secure(post["content"], True), "html.parser"
    ).getText()
    ...
    laugh_count = db.mb_reaction.count_documents(
        {"post_id": post_id, "reaction": "laugh"}
    )
...
def oembedapi():
    ...
    content = BeautifulSoup(
        little_conponment.markdown_to_html_secure(post["content"]), "html.parser"
    ).getText()
